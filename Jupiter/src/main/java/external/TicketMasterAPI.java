...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "ofUVGTSuLwfGgIun28AoZDDLmivjbjRt";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		String query = String.format("apikey=%s&geoPoint=%s&keyword=%s&radius=%s", API_KEY, geoHash, keyword, 500);
		try {
